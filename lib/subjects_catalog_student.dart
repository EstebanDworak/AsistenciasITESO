...
class SubjectCatalogStudent extends StatefulWidget {
  // final Function cb;
  // final String email;
  final GoogleSignInAccount account;

  const SubjectCatalogStudent({Key key, @required this.account})
      : super(key: key);

  @override
  _SubjectCatalogStudentState createState() => _SubjectCatalogStudentState();
}

class _SubjectCatalogStudentState extends State<SubjectCatalogStudent> {
                ...
                child: Column(
                  children: <Widget>[
                    ListTile(
                        ...
                        subtitle: Text(_subjects[index].schedule),
